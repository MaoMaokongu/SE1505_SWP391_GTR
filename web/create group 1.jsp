<%-- 
    Document   : create group 1
    Created on : Jan 25, 2022, 9:35:16 AM
    Author     : Admin
--%>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <!-- <a href="my group.html" class="list-group-item list-group-item-action bg-transparent second-text active"><i 
            ...
            <div id="page-content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="fs-2 m-0">Group: "Name"</h2>
                    </div>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row my-5">
                        ...
                        <div class="createbutton">
                            Group Name: <input type="text" name=""> <button><a href="create group 1.html">Create</a></button>
                            <button><a href="viewListNoGroup.html">Invite</a></button>
                        </div>
                        <div class="row">
                            <div class="input-group col-sm">
                                ...
                                <!-- <a href="viewListNoGroup.html" type="button" class="btn btn-primary">Invite</a> -->
                                <!--  </button> -->
