<%-- 
    Document   : adminStudentProject
    Created on : Jan 25, 2022, 9:33:54 AM
    Author     : Admin
--%>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    <div class="sidenav">
                        <button
                            class="dropdown-btn list-group-item list-group-item-action bg-transparent second-text active">
                    ...
                    <a href="adminProject.jsp"
                       class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                            class="fas fa-project-diagram me-2"></i>Management Projects</a>
                    <a href="adminGroup.jsp"
                       class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                            class="fas fa-user me-2"></i>Management Groups</a>
                    <a href="adminLecturer.jsp"
                       class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                            class="fas fa-comments me-2"></i>Management Lecturers</a>
            ...
            <div id="page-content-wrapper">
                <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                    <div class="d-flex align-items-center">
                        ...
                        <h2 class="fs-2 m-0">Group Management System</h2>
                    </div>
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row my-5">
                        <h3 class="fs-4 mb-3">Students with Group</h3>
                        <!-- <li class="search-box">
