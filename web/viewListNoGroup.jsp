<%-- 
    Document   : viewListNoGroup
    Created on : Jan 25, 2022, 9:41:59 AM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Student Group Register</title>
    </head>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="create group.jsp" class="list-group-item list-group-item-action bg-transparent second-text active"><i 
            ...
            <div id="page-content-wrapper">
                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="row my-5">
                        <h3 class="fs-4 mb-3">List of Invited Students </h3>
                        <!-- <li class="search-box">
                            ...
                            <table class="table bg-white rounded shadow-sm  table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Male</td>
                                        <td>
                                            <button id="1" class="btn btn-primary">invite</button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">2</th>
                                        <td>SE151138</td>
                                        ...
                                        <td>Le Van Trung</td>
                                        <td>Male</td>
                                        <td><button id="2" class="btn btn-primary">invite</button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">3</th>
                                        <td>SE151138</td>
                                        ...
                                        <td>Le Van Trung</td>
                                        <td>Male</td>
                                        <td><button id="3" class="btn btn-primary">invite</button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">4</th>
                                        <td>SE151138</td>
                                        ...
                                        <td>Le Van Trung</td>
                                        <td>Male</td>
                                        <td><button id="4" class="btn btn-primary">invite</button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">5</th>
                                        <td>SE151138</td>
                                        ...
                                        <td>Le Van Trung</td>
                                        <td>Male</td>
                                        <td><button id="5" class="btn btn-primary">invite</button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row">6</th>
                                        <td>SE151138</td>
                                        ...
                                        <td>Le Van Trung</td>
                                        <td>Male</td>
                                        <td><button id="6" class="btn btn-primary">invite</button></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
    ...
    <script src="js/InviteButton.js"></script>
