                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li><a href="../../adminHasGroup.jsp"><i class="fa fa-circle-o"></i> Group</a></li>
                                        <li class="active"><a href="#"><i class="fa fa-circle-o"></i> No Group</a></li>
                                    </ul>
                                </li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="list d-flex align-items-center justify-content-start">
                        <button type="button" class="btn btn-primary btn-sm btn-student">Save</button>

                        <button type="button" class="btn btn-default btn-sm btn-student"><a href="adminNoGroup.jsp">Back No Group
                                Page</a></button>
                    </div>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Manage Students</a></li>
                        <li><a href="adminNoGroup.jsp">No Group</a></li>
