<%-- 
    Document   : adminNoGroup
    Created on : Mar 5, 2022, 11:33:40 PM
    Author     : Admin
--%>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <div class="list d-flex align-items-center justify-content-start">
                        ...
                        <button type="button" class="btn btn-default btn-sm btn-student"><a
                                href="adminRandom.jsp">Random</a></button>
                    </div>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Manage Students</a></li>
                        <li class="active">No Group</li>
                    </ol>
                </section>
