                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="treeview">
                                    ...
                                    <ul class="treeview-menu">
                                        <li class="active"><a href="#"><i class="fa fa-circle-o"></i> Group</a></li>
                                        <li><a href="pages/admin/adminNoGroup.jsp"><i class="fa fa-circle-o"></i> No Group</a></li>
                                    </ul>
                                </li>
