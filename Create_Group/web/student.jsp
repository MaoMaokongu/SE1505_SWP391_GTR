<%-- 
    Document   : student
    Created on : Jan 10, 2022, 11:13:00 PM
    Author     : admin
--%>
...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <c:if test="${loginUser == null || loginUser.role_id.role_name ne 'Student'}">
        ...
        <div class="sidebar">
            <div class="logo-details">
                ...
                <div class="logo_name">SWP Project</div>
...
<!--                <li>
                    ...
                    <span class="tooltip">Đồ án đã đăng kí</span>
                </li>-->
<!--                <li>
                    <a href="#">
                ...
                <li>
                <c:url var="myGroup" value="GroupController">
                    <c:param name="group_id" value="${sessionScope.USER.group_id.group_id}"></c:param>
                </c:url>
                    <a href="${myGroup}">
                        <i class='bx bx-cog' ></i>
                        <span class="links_name">Your Group</span>
                    </a>
                    <span class="tooltip">Your Group</span>
                </li>
                <li class="profile">
                    ...
                    <a href="${logoutLink}"><i class='bx bx-log-out' id="log_out" ></i></a>
                </li>
            </ul>
        </div>
